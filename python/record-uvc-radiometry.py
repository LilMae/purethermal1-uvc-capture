        ...
        try:
            ...
            try:
                ...
                folder_path = os.path.join(
                    os.getcwd(),
                    f"{tm.tm_mon}_{tm.tm_mday}_{tm.tm_hour}_{tm.tm_min}_{tm.tm_sec}",
                )
                ...
                while True:
                    ...
                    img_np = raw_to_8bit(data)
                    file_name = f"{frame_idx}.npy"
                    np.save(os.path.join(folder_path, file_name), img_np)
                    print(f"{frame_idx}th frame is saved")
            finally:
